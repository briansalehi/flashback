...
namespace flashback
{
    ...
    public:
        ...
        // user handling
        [[nodiscard]] virtual bool create_session(uint64_t user_id, std::string_view token,
                                                  std::string_view device) const = 0;
        [[nodiscard]] virtual uint64_t create_user(std::string_view name, std::string_view email,
        ...
        // milestones
        [[nodiscard]] virtual Milestone add_milestone(uint64_t subject_id, expertise_level subject_level,
                                                      uint64_t roadmap_id) const = 0;
        [[nodiscard]] virtual Milestone add_milestone(uint64_t subject_id, expertise_level subject_level,
                                                      uint64_t roadmap_id, uint64_t position) const = 0;
        ...
        [[nodiscard]] virtual std::vector<Milestone> get_requirements(uint64_t roadmap_id, uint64_t subject_id,
                                                                      expertise_level subject_level) const = 0;
        virtual void reorder_milestone(uint64_t roadmap_id, uint64_t current_position,
        ...
        [[nodiscard]] virtual Topic create_topic(uint64_t subject_id, std::string name,
                                                 flashback::expertise_level level, uint64_t position) const = 0;
        [[nodiscard]] virtual std::map<uint64_t, Topic> get_topics(uint64_t subject_id, expertise_level level) const =
        0;
        virtual void reorder_topic(uint64_t subject_id, expertise_level level, uint64_t source_position,
                                   uint64_t target_position) const = 0;
        virtual void remove_topic(uint64_t subject_id, expertise_level level, uint64_t position) const = 0;
        virtual void merge_topics(uint64_t subject_id, expertise_level level, uint64_t source_position,
                                  uint64_t target_position) const = 0;
        virtual void rename_topic(uint64_t subject_id, expertise_level level, uint64_t position,
                                  std::string name) const = 0;
        virtual void move_topic(uint64_t subject_id, expertise_level level, uint64_t position,
                                uint64_t target_subject_id, uint64_t target_position) const = 0;
        [[nodiscard]] virtual std::map<uint64_t, Topic> search_topics(uint64_t subject_id, expertise_level level,
                                                                      std::string_view search_pattern) const = 0;
        virtual void change_topic_level(uint64_t subject_id, uint64_t position, flashback::expertise_level level,
                                        flashback::expertise_level target) const = 0;
        ...
        [[nodiscard]] virtual std::map<uint64_t, Presenter> search_presenters(std::string_view search_pattern) const =
        0;
        ...
        // sections
        [[nodiscard]] virtual Section create_section(uint64_t resource_id, uint64_t position, std::string name,
                                                     std::string link) const = 0;
        ...
        virtual void reorder_section(uint64_t resource_id, uint64_t current_position,
                                     uint64_t target_position) const = 0;
        ...
        virtual void move_section(uint64_t resource_id, uint64_t position, uint64_t target_resource_id,
                                  uint64_t target_position) const = 0;
        [[nodiscard]] virtual std::map<uint64_t, Section> search_sections(
            uint64_t resource_id, std::string_view search_pattern) const = 0;
        ...
        virtual void add_card_to_topic(uint64_t card_id, uint64_t subject_id, uint64_t topic_position,
                                       expertise_level topic_level) const = 0;
        ...
        [[nodiscard]] virtual std::map<uint64_t, Card> search_cards(uint64_t subject_id, expertise_level level,
                                                                    std::string_view search_pattern) const = 0;
        virtual void move_card_to_section(uint64_t card_id, uint64_t resource_id, uint64_t section_position,
                                          uint64_t target_section_position) const = 0;
        virtual void move_card_to_topic(uint64_t card_id, uint64_t subject_id, uint64_t topic_position,
                                        expertise_level topic_level, uint64_t target_subject, uint64_t target_position,
                                        expertise_level targe_level) const = 0;
        [[nodiscard]] virtual std::vector<Card> get_section_cards(uint64_t resource_id,
                                                                  uint64_t sections_position) const = 0;
        [[nodiscard]] virtual std::vector<Card> get_topic_cards(uint64_t subject_id, uint64_t topic_position,
                                                                expertise_level topic_level) const = 0;
        ...
        [[nodiscard]] virtual std::map<uint64_t, Block> split_block(uint64_t card_id, uint64_t block_position) const =
        0;
        virtual void move_block(uint64_t card_id, uint64_t block_position, uint64_t target_card_id,
                                uint64_t target_position) const = 0;
        ...
        virtual std::vector<Card> get_practice_cards(uint64_t user_id, uint64_t subject_id,
