...
function(define_tests)
    ...
    foreach(test_file ${DEFINE_TESTS_FILES})
        ...
        target_link_libraries(${test_unit} PRIVATE ${DEFINE_TESTS_TARGET} gtest gtest_main)
    ...
    target_link_libraries(${DEFINE_TESTS_TARGET}-tests PRIVATE ${DEFINE_TESTS_TARGET} gtest gtest_main)
